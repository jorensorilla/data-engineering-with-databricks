...
-- MAGIC %md
-- MAGIC # This is supposed to be a header with the following bullets:
-- MAGIC * First bullet
-- MAGIC * Second bullet
-- MAGIC 
-- MAGIC This is a link <a href="https://www.databricks.training/step-by-step/importing-courseware-from-github/">on github!</a>
